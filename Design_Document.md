...
* **Embedding Service — Hugging Face:** Generates 384-dimensional semantic embeddings using ll-MiniLM-L6-v2.
...
Frontend and backend dependencies are maintained separately through 
equirements.txt and ackend-requirements.txt.
